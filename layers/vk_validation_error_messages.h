...
enum UNIQUE_VALIDATION_ERROR_CODE {
    ...
    VALIDATION_ERROR_MAX_ENUM = 2522,
};
...
static std::unordered_map<int, char const *const> validation_error_map{
    ...
    {VALIDATION_ERROR_02499, "For more information refer to Vulkan Spec Section '28.4. Indirect Commands Generation' which states 'pIndirectCommandsTokens must be a pointer to an array of tokenCount valid VkIndirectCommandsTokenNVX structures' (https://www.khronos.org/registry/vulkan/specs/1.0-extensions/xhtml/vkspec.html#VkCmdProcessCommandsInfoNVX)"},
