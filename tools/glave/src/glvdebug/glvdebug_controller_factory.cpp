...
glvdebug_controller* glvdebug_controller_factory::Load(const char* filename)
{
    ...
    if (pController != NULL)
    {
        ...
        pController->ProcessTraceFile = (funcptr_glvdebug_controller_process_trace_file)glv_platform_get_library_entrypoint(pLibrary, "glvdebug_controller_process_trace_file");
        ...
        assert(pController->ProcessTraceFile != NULL);
