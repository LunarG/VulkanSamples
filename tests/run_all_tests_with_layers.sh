...
# enable layers
export VK_INSTANCE_LAYERS=VK_LAYER_LUNARG_Threading:VK_LAYER_LUNARG_MemTracker:VK_LAYER_LUNARG_ObjectTracker:VK_LAYER_LUNARG_DrawState:VK_LAYER_LUNARG_ParamChecker:VK_LAYER_LUNARG_ShaderChecker:VK_LAYER_LUNARG_Swapchain:VK_LAYER_LUNARG_DeviceLimits:VK_LAYER_LUNARG_Image
export VK_DEVICE_LAYERS=VK_LAYER_LUNARG_Threading:VK_LAYER_LUNARG_MemTracker:VK_LAYER_LUNARG_ObjectTracker:VK_LAYER_LUNARG_DrawState:VK_LAYER_LUNARG_ParamChecker:VK_LAYER_LUNARG_ShaderChecker:VK_LAYER_LUNARG_Swapchain:VK_LAYER_LUNARG_DeviceLimits:VK_LAYER_LUNARG_Image
