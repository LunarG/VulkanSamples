...
//void print(eColor col,const char* format,...);
    ...
    #define _LOGV(...) {color(eCYAN);    printf("PERF : "  );  color(eRESET); printf(__VA_ARGS__);}
    #define _LOGD(...) {color(eBLUE);    printf("DEBUG: "  );  color(eRESET); printf(__VA_ARGS__);}
    #define _LOGI(...) {color(eGREEN);   printf("INFO : "  );  color(eRESET); printf(__VA_ARGS__);}
    #define _LOGW(...) {color(eYELLOW);  printf("WARNING: ");  color(eRESET); printf(__VA_ARGS__);}
    #define _LOGE(...) {color(eRED);     printf("ERROR: "  );  color(eRESET); printf(__VA_ARGS__);}
#endif
