...
static inline void sample_platform_thread_create_mutex(sample_platform_thread_mutex* pMutex)
{
    pthread_mutex_init(pMutex, NULL);
}
static inline void sample_platform_thread_lock_mutex(sample_platform_thread_mutex* pMutex)
{
    pthread_mutex_lock(pMutex);
}
static inline void sample_platform_thread_unlock_mutex(sample_platform_thread_mutex* pMutex)
{
    pthread_mutex_unlock(pMutex);
}
static inline void sample_platform_thread_delete_mutex(sample_platform_thread_mutex* pMutex)
{
    pthread_mutex_destroy(pMutex);
}
typedef pthread_cond_t sample_platform_thread_cond;
static inline void sample_platform_thread_init_cond(sample_platform_thread_cond* pCond)
{
...
static inline void sample_platform_thread_cond_broadcast(sample_platform_thread_cond* pCond)
{
...
static void sample_platform_thread_create_mutex(sample_platform_thread_mutex* pMutex)
{
    InitializeCriticalSection(pMutex);
}
static void sample_platform_thread_lock_mutex(sample_platform_thread_mutex* pMutex)
{
    EnterCriticalSection(pMutex);
}
static void sample_platform_thread_unlock_mutex(sample_platform_thread_mutex* pMutex)
{
    LeaveCriticalSection(pMutex);
}
static void sample_platform_thread_delete_mutex(sample_platform_thread_mutex* pMutex)
{
    DeleteCriticalSection(pMutex);
}
typedef CONDITION_VARIABLE sample_platform_thread_cond;
static void sample_platform_thread_init_cond(sample_platform_thread_cond* pCond)
{
...
static void sample_platform_thread_cond_broadcast(sample_platform_thread_cond* pCond)
{
