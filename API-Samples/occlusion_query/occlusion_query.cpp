...
/* We've setup cmake to process occlusion_query.vert and occlusion_query.frag             */
...
#include "occlusion_query.vert.h"
#include "occlusion_query.frag.h"
    VkShaderModuleCreateInfo vert_info = {};
    VkShaderModuleCreateInfo frag_info = {};
    vert_info.sType = frag_info.sType = VK_STRUCTURE_TYPE_SHADER_MODULE_CREATE_INFO;
    vert_info.codeSize = sizeof(occlusion_query_vert);
    vert_info.pCode = occlusion_query_vert;
    frag_info.codeSize = sizeof(occlusion_query_frag);
    frag_info.pCode = occlusion_query_frag;
